...
var (
	userDBTypes = map[string]string{`ID`: `int`, `Username`: `varchar`, `Email`: `varchar`, `FirstName`: `varchar`, `LastName`: `varchar`, `Password`: `varchar`, `IsAdmin`: `tinyint`, `CreatedAt`: `datetime`, `UpdatedAt`: `datetime`}
	_           = bytes.MinRead
)
