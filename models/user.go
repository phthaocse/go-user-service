...
type User struct {
	ID        int         `boil:"_id" json:"_id" toml:"_id" yaml:"_id"`
	Username  string      `boil:"username" json:"username" toml:"username" yaml:"username"`
	Email     string      `boil:"email" json:"email" toml:"email" yaml:"email"`
	FirstName null.String `boil:"first_name" json:"first_name,omitempty" toml:"first_name" yaml:"first_name,omitempty"`
	LastName  null.String `boil:"last_name" json:"last_name,omitempty" toml:"last_name" yaml:"last_name,omitempty"`
	Password  null.String `boil:"password" json:"password,omitempty" toml:"password" yaml:"password,omitempty"`
	IsAdmin   null.Bool   `boil:"is_admin" json:"is_admin,omitempty" toml:"is_admin" yaml:"is_admin,omitempty"`
...
var UserWhere = struct {
	...
	ID:        whereHelperint{field: "`user`.`_id`"},
	...
	IsAdmin:   whereHelpernull_Bool{field: "`user`.`is_admin`"},
...
var (
	userAllColumns            = []string{"_id", "username", "email", "first_name", "last_name", "password", "is_admin", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"username", "email", "first_name", "last_name", "password", "created_at", "updated_at"}
	userColumnsWithDefault    = []string{"_id", "is_admin"}
...
func FindUser(ctx context.Context, exec boil.ContextExecutor, iD int, selectCols ...string) (*User, error) {
	...
	query := fmt.Sprintf(
		"select %s from `user` where `_id`=?", sel,
	)
...
func (o *User) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	...
	o.ID = int(lastID)
	if lastID != 0 && len(cache.retMapping) == 1 && cache.retMapping[0] == userMapping["_id"] {
		goto CacheNoHooks
	}
...
func (o *User) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM `user` WHERE `_id`=?"
...
func UserExists(ctx context.Context, exec boil.ContextExecutor, iD int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from `user` where `_id`=? limit 1)"
